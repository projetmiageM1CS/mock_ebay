...
public class SuppressionAnnonceServlet {
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        // TODO Auto-generated method stub
	    	 ...
	    	 try
	         {
	 		     ...
	 		     Integer prixAn=Integer.parseInt(request.getParameter("titreannonce"));
	 		    String photoAn=request.getParameter("photoannonce");
	 		      System.out.println(nomAn+" "+descriptionAn+" "+prixAn+" "+photoAn);
	 		      ResultSet resultat2 = statement.executeQuery("delete into annonce (titreannonce, descriptionannonce, prixannonce, photoannonce) values ('"+nomAn+"' ,'"+descriptionAn+"','"+prixAn+"','"+photoAn+"') ");
